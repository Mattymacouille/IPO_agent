...
async function fetchAndDisplayIPOs() {
    try {
        // On récupère les IPO triées par la date d'analyse la plus récente
        ...
        ipos.forEach(ipo => {
            ...
            // Gestion de la couleur des badges de risque
            ...
            const formattedDate = ipo.ipo_date ? new Date(ipo.ipo_date).toLocaleDateString('fr-FR', dateOption) : 'Date inconnue';
            ...
            card.innerHTML = `
                <div>
                    ...
                    <div class="mt-4 text-sm text-slate-300 line-clamp-4 whitespace-pre-line border-t border-slate-900 pt-3">
                        ${ipo.ai_report}
                    </div>
                </div>
